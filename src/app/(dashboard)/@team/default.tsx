...
export default function TeamSlot() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-slate-700/30 rounded-lg p-4">
        <div className="flex items-center space-x-3 mb-4">
          <div className="relative">
            ...
            <div
              className={`absolute -bottom-1 -right-1 w-4 h-4 ${getStatusColor(user.status)} rounded-full border-2 border-slate-800`}
            ></div>
          </div>
      ...
      {/* Team Members */}
      <div>
        <h3 className="text-slate-300 text-sm font-medium mb-3 px-2">
          Team Members
        </h3>
        <div className="space-y-2">
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className="flex items-center space-x-3 p-2 rounded-lg hover:bg-slate-700/30 transition-all"
            >
              <div className="relative">
                ...
                <div
                  className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 ${getStatusColor(member.status)} rounded-full border border-slate-800`}
                ></div>
              </div>
              <div className="flex-1 min-w-0">
