...
const Card : React.FC<ItemCardProps> = ({ card }) => {
  ...
  return (
    <div className="relative flex-none w-40 md:w-[180px] mx-2 md:hover:scale-110 hover:cursor-pointer hover:transition-all">
      <div className="relative h-64 rounded-lg overflow-hidden group">
        <Image
          src={`https://img.ophim.live/uploads/movies/${thumb_url}` || "/api/placeholder/192/256"}
          alt={origin_name || ""}
          fill
